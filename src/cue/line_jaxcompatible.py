...
class predict():
    ...
    def __init__(self, particlenumber, pca_basis=line_PCABasis, nn=line_speculator, theta=None, gammas=None, log_L_ratios=None, log_QH=None, 
        ...
        self.n_sample = np.array(particlenumber)
